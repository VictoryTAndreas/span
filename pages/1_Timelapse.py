...
# Namibia-focused GOES sample regions
goes_rois = {
    "Namibia - Country Extent": {
        "region": Polygon(
            [
                [11.5, -29.0],  # Southwest
                [11.5, -16.5],  # Northwest
                [25.5, -16.5],  # Northeast
                [25.5, -29.0],  # Southeast
                [11.5, -29.0],  # Close polygon
            ]
        ),
        "start_time": "2024-01-01T00:00:00",
        "end_time": "2024-01-02T23:59:59",
    },
    "Namibia - Central (Windhoek Area)": {
        "region": Polygon(
            [
                [16.5, -23.0],
                [16.5, -22.0],
...
# Namibia-focused Landsat sample regions
landsat_rois = {
    "Namibia - Country Extent": Polygon(
        [
            [11.5, -29.0],
            [11.5, -16.5],
            [25.5, -16.5],
    ...
    "Namibia - Walvis Bay/Swakopmund": Polygon(
        [
            [14.4, -23.0],
            [14.4, -22.8],
            [14.7, -22.8],
    ...
    "Namibia - Etosha National Park": Polygon(
        [
            [15.5, -19.5],
            [15.5, -18.5],
            [17.0, -18.5],
...
modis_rois = {
    ...
    "Namibia - Northern Region": Polygon(
        [
            [14.0, -20.0],
            [14.0, -17.0],
            [21.0, -17.0],
    ...
    "Namibia - Central Region": Polygon(
        [
            [14.5, -24.0],
            [14.5, -21.0],
            [19.0, -21.0],
    ...
    "Namibia - Southern Region": Polygon(
        [
            [15.0, -28.0],
            [15.0, -24.0],
            [20.0, -24.0],
...
# Namibia-focused Ocean regions
ocean_rois = {
    "Namibian Coast - Northern": Polygon(
        [
            [11.0, -20.0],
            [11.0, -17.0],
            [13.0, -17.0],
    ...
    "Namibian Coast - Central": Polygon(
        [
            [11.0, -24.0],
            [11.0, -20.0],
            [14.0, -20.0],
    ...
    "Namibian Coast - Southern": Polygon(
        [
            [11.0, -29.0],
            [11.0, -24.0],
            [16.0, -24.0],
    ...
    "Benguela Current Region": Polygon(
        [
            [8.0, -35.0],
            [8.0, -15.0],
            [18.0, -15.0],
...
def app():
    ...
    st.title("Create Satellite Timelapse - Namibia Focus")

    st.markdown(
        """
        An interactive web app for creating [Landsat](https://developers.google.com/earth-engine/datasets/catalog/landsat)/[GOES](https://jstnbraaten.medium.com/goes-in-earth-engine-53fbc8783c16) timelapse for any location around the globe, with special focus on Namibia.
        ...
        Created by VTA Namibia - Your partner in geospatial solutions.
    """
    )
    ...
    with row1_col2:
        ...
        keyword = st.text_input("Search for a location in Namibia:", "Windhoek, Namibia")
        if keyword:
        ...
        sample_roi = st.selectbox(
            "Select a sample ROI (Namibia-focused) or upload a GeoJSON file:",
            roi_options,
            index=0,
        )
    ...
    with row1_col2:
        ...
        if collection in [
            ...
            if collection == "Landsat TM-ETM-OLI Surface Reflectance":
                ...
                timelapse_title = "Namibia Landsat Timelapse"
                timelapse_speed = 5
            elif collection == "Sentinel-2 MSI Surface Reflectance":
                sensor_start_year = 2015
                timelapse_title = "Namibia Sentinel-2 Timelapse"
                timelapse_speed = 5
            ...
            with st.form("submit_ts_form"):
                with st.expander("Customize timelapse"):
                    ...
                    title = st.text_input(
                        "Enter a title to show on the timelapse: ", "Namibia Timelapse"
                    )
